...
{
    public class War14Item : _MapItems
    {
        ...
        public War14Item(Vector2 position)
        {
        ...
        public static void WorldSpawn()
        {
            ...
            Vector2 pos = ChallengerMod.HarmonyMain.Instance.GetAllApplicableItemPositions14().Random();
            ChallengerMod.HarmonyMain.Instance.RpcSpawnItem(14, pos);
            HasSpawned = true;
        }

        public static bool CanSpawn()
        {
            if (ChallengerMod.HarmonyMain.Instance.AllItems.Where(x => x.Id == 14).ToList().Count > 0) return false;
